...
require("./resultCard.css");
var QuizResultCard = function (props) {
    // Calculate success rate
    var successRate = Math.round((props.result.results.right / props.result.results.numberOfQuestions) * 100);
      ...
      <div className="result-card__content">
        <div className="result-card__score">
          <div className="result-card__score-circle" style={{
            background: "conic-gradient(\n                var(--ifm-color-primary) ".concat(successRate, "%,\n                var(--ifm-color-emphasis-200) 0\n              )")
        }}>
...
exports.default = QuizResultCard;
