...
Thus, it is possible to define one [Suite Setup](../glossary#suite-setup) that is executed at the very start of the execution before any other [Suite Setup](../glossary#suite-setup), [Test|[Task](../glossary#task) Setup](../glossary#test-setup), and Test|[Task](../glossary#task) is executed.
...
- **`*** Keywords ***` Section (optional)**:
  ...
  Define keywords that are available to the initialization file for [Suite](../glossary#suite) Setup, [Suite](../glossary#suite) Teardown, [Test Setup](../glossary#test-setup), or [Test Teardown](../glossary#test-teardown).
