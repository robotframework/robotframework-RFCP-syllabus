...
Thus, it is possible to define one [Suite](../glossary#suite) Setup that is executed at the very start of the execution before any other [Suite](../glossary#suite) Setup, [Test|[Task](../glossary#task) Setup](../glossary#test-setup), and Test|[Task](../glossary#task) is executed.
